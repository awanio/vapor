...
func KubernetesRoutes(r *gin.RouterGroup, eventsHub *websocket.Hub) {
	...
	// Start event forwarder (best-effort)
	go kubernetes.StartEventForwarder(context.Background(), kubernetesService, eventsHub)
