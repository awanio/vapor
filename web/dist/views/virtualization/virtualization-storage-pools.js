...
let VirtualizationStoragePools = class VirtualizationStoragePools extends LitElement {
    constructor() {
        super(...arguments);
        this.pools = [];
        this.searchQuery = '';
    ...
    getActions(pool) {
        ...
        if (pool.state === 'active') {
            actions.push({ label: 'Refresh', action: 'refresh' }, { label: 'Stop', action: 'stop' });
        }
        else {
    ...
    getFilteredData() {
        ...
        if (this.searchQuery) {
            data = data.filter(pool => JSON.stringify(pool).toLowerCase().includes(this.searchQuery.toLowerCase()));
        }
        return data;
    }
...
VirtualizationStoragePools.styles = css `
    :host {
      display: block;
      height: 100%;
      padding: 24px;
...
__decorate([
    property({ type: Array })
], VirtualizationStoragePools.prototype, "pools", void 0);
__decorate([
    property({ type: String })
], VirtualizationStoragePools.prototype, "searchQuery", void 0);
__decorate([
    property({ type: Boolean })
], VirtualizationStoragePools.prototype, "loading", void 0);
__decorate([
    property({ type: String })
], VirtualizationStoragePools.prototype, "error", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "activeTab", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "showDetails", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "selectedPool", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "showDeleteModal", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "itemToDelete", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "isDeleting", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "showCreateDrawer", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "createResourceValue", void 0);
__decorate([
    state()
], VirtualizationStoragePools.prototype, "isCreating", void 0);
VirtualizationStoragePools = __decorate([
    customElement('virtualization-storage-pools')
], VirtualizationStoragePools);
export { VirtualizationStoragePools };
//# sourceMappingURL=virtualization-storage-pools.js.map