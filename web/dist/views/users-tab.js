...
export class UsersTab extends LitElement {
    ...
    openDeleteModal(username) {
        ...
        const modal = this.shadowRoot?.querySelector('#deleteModal');
        if (modal) {
            modal.open = true;
        }
    }
    ...
    openResetPasswordDrawer(username) {
    ...
    updateEditingUser(field, value) {
        ...
        if (field === 'groups') {
            this.editingUser = {
                ...this.editingUser,
                groups: value.split(',').map((g) => g.trim()).filter(Boolean)
            };
        }
        else {
              ...
              <tr>
                ...
                <td>
                  <div class="action-menu">
                    <button class="action-dots" @click=${(e) => this.toggleActionMenu(e, `user-${index}`)}>⋮</button>
...
__decorate([
    property({ type: Boolean })
], UsersTab.prototype, "showEditForm", void 0);
__decorate([
    property({ type: Boolean })
], UsersTab.prototype, "showResetPasswordForm", void 0);
__decorate([
    property({ type: Object })
], UsersTab.prototype, "newUser", void 0);
__decorate([
    property({ type: Object })
], UsersTab.prototype, "editingUser", void 0);
__decorate([
    property({ type: String })
], UsersTab.prototype, "userToDelete", void 0);
__decorate([
    property({ type: String })
], UsersTab.prototype, "resetPasswordUsername", void 0);
__decorate([
    property({ type: String })
], UsersTab.prototype, "newPassword", void 0);
__decorate([
    property({ type: String })
], UsersTab.prototype, "confirmPassword", void 0);
__decorate([
    property({ type: String })
], UsersTab.prototype, "searchQuery", void 0);
