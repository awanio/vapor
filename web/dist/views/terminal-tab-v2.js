...
import { t } from '../i18n';
import { terminalStore, activeSessionId, sessionList, activeSession, connectedSessionsCount } from '../stores/shared/terminal';
import { StoreController } from '../stores/utils/lit-mixin';
let TerminalTabV2 = class TerminalTabV2 extends LitElement {
    constructor() {
        super(...arguments);
        this.activeSessionController = new StoreController(this, activeSessionId);
        this.sessionListController = new StoreController(this, sessionList);
        this.activeSessionStateController = new StoreController(this, activeSession);
        this.connectedCountController = new StoreController(this, connectedSessionsCount);
        this.isFullscreen = false;
        this.localSessions = [];
        this.localActiveSessionId = null;
    ...
    async setupTerminals() {
        await this.updateComplete;
        for (const session of this.localSessions) {
            const wrapper = this.shadowRoot?.querySelector(`#${session.id} .terminal-wrapper`);
    ...
    render() {
      ...
      <div class="terminal-header">
        <div class="terminal-tabs">
          ${repeat(this.localSessions, (session) => session.id, (session) => html `
              <button 
                class=${classMap({
            'terminal-tab': true,
            ...
            'disconnected': session.connectionStatus === 'disconnected'
                ...
                ${this.localSessions.length > 1 ? html `
                  <button 
                    ...
                    @click=${(e) => this.closeSession(session.id, e)}
...
__decorate([
    state()
], TerminalTabV2.prototype, "isFullscreen", void 0);
__decorate([
    state()
], TerminalTabV2.prototype, "localSessions", void 0);
__decorate([
    state()
], TerminalTabV2.prototype, "localActiveSessionId", void 0);
__decorate([
    state()
], TerminalTabV2.prototype, "localActiveSession", void 0);
TerminalTabV2 = __decorate([
    customElement('terminal-tab-v2')
], TerminalTabV2);
export { TerminalTabV2 };
//# sourceMappingURL=terminal-tab-v2.js.map