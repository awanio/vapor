...
let AnsibleExecutionDrawer = class AnsibleExecutionDrawer extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        this.loading = false;
    ...
    startStreaming() {
        if (!this.executionId || this.wsManager)
            return;
        this.streaming = true;
        this.wsManager = AnsibleService.createExecutionStream(this.executionId, (message) => {
            if (message.type === 'output' && message.content) {
                ...
                if (message.result) {
                    if (this.execution) {
                        this.execution.status = message.result.status;
    ...
    async rerun() {
        if (!this.execution || !this.execution.parameters)
            return;
...
AnsibleExecutionDrawer.styles = css `
    :host {
      display: block;
      position: fixed;
      top: 0;
...
], AnsibleExecutionDrawer.prototype, "executionId", void 0);
__decorate([
    property({ type: Boolean })
], AnsibleExecutionDrawer.prototype, "open", void 0);
__decorate([
    state()
], AnsibleExecutionDrawer.prototype, "execution", void 0);
__decorate([
    state()
], AnsibleExecutionDrawer.prototype, "loading", void 0);
__decorate([
    state()
], AnsibleExecutionDrawer.prototype, "streaming", void 0);
__decorate([
    state()
], AnsibleExecutionDrawer.prototype, "output", void 0);
__decorate([
    state()
], AnsibleExecutionDrawer.prototype, "error", void 0);
AnsibleExecutionDrawer = __decorate([
    customElement('ansible-execution-drawer')
], AnsibleExecutionDrawer);
export { AnsibleExecutionDrawer };
//# sourceMappingURL=ansible-execution-drawer.js.map