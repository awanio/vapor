...
let CreateResourceDrawer = class CreateResourceDrawer extends LitElement {
    constructor() {
        super(...arguments);
        this.show = false;
...
CreateResourceDrawer.styles = css `
    :host {
      display: block;
      position: fixed;
      top: 0;
...
], CreateResourceDrawer.prototype, "show", void 0);
__decorate([
    property({ type: String })
], CreateResourceDrawer.prototype, "title", void 0);
__decorate([
    property({ type: String })
], CreateResourceDrawer.prototype, "value", void 0);
__decorate([
    property({ type: Boolean })
], CreateResourceDrawer.prototype, "loading", void 0);
__decorate([
    property({ type: String })
], CreateResourceDrawer.prototype, "error", void 0);
__decorate([
    property({ type: String })
], CreateResourceDrawer.prototype, "format", void 0);
__decorate([
    property({ type: String })
], CreateResourceDrawer.prototype, "submitLabel", void 0);
__decorate([
    state()
], CreateResourceDrawer.prototype, "validationMessage", void 0);
__decorate([
    state()
], CreateResourceDrawer.prototype, "validationStatus", void 0);
CreateResourceDrawer = __decorate([
    customElement('create-resource-drawer')
], CreateResourceDrawer);
export { CreateResourceDrawer };
//# sourceMappingURL=create-resource-drawer.js.map