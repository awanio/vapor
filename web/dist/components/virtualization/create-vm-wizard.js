...
import { $vmWizardState, $availableStoragePools, $availableISOs, wizardActions, vmActions, storagePoolStore, isoStore, } from '../../stores/virtualization';
import '../ui/loading-state.js';
import '../ui/empty-state.js';
let CreateVMWizard = class CreateVMWizard extends LitElement {
    constructor() {
        super(...arguments);
        this.wizardController = new StoreController(this, $vmWizardState);
        this.storagePoolsController = new StoreController(this, $availableStoragePools);
        this.isosController = new StoreController(this, $availableISOs);
    ...
    async handleCreate() {
        ...
        try {
            ...
            if (result.success) {
                ...
                this.showNotification('Failed to create virtual machine', 'error');
            }
        }
        catch (error) {
            console.error('Failed to create VM:', error);
            this.showNotification(error instanceof Error ? error.message : 'Failed to create virtual machine', 'error');
        }
        finally {
            this.isCreating = false;
        }
                ...
                <div class="disk-info">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      @input=${(e) => this.updateDisk(index, 'size', Number(e.target.value))}
                    /> GB
                  </div>
                  <div>
                    Format: 
                    <select
                      ...
                      @change=${(e) => this.updateDisk(index, 'format', e.target.value)}
                    >
        ...
        ${networkConfig.type === 'bridge' ? html `
          <div class="form-group">
            ...
            <input
              ...
              @input=${(e) => this.updateFormData('network', {
            ...networkConfig,
          ...
          <div class="advanced-options">
            <div class="form-group">
              ...
              <select
                ...
                @change=${(e) => this.updateFormData('network', {
            ...networkConfig,
...
__decorate([
    state()
], CreateVMWizard.prototype, "isCreating", void 0);
__decorate([
    state()
], CreateVMWizard.prototype, "validationErrors", void 0);
__decorate([
    state()
], CreateVMWizard.prototype, "showAdvancedOptions", void 0);
CreateVMWizard = __decorate([
    customElement('create-vm-wizard')
], CreateVMWizard);
export { CreateVMWizard };
//# sourceMappingURL=create-vm-wizard.js.map