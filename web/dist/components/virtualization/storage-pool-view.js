...
import { storagePoolStore, storageActions } from '../../stores/virtualization';
import { virtualizationAPI } from '../../services/virtualization-api';
import { notificationActions } from '../../stores/notifications';
let StoragePoolView = class StoragePoolView extends LitElement {
    constructor() {
        super(...arguments);
        this.storagePoolsController = new StoreController(this, storagePoolStore.$items);
        this.selectedPoolController = null;
    ...
    async handleDeleteVolume(pool, volume) {
        ...
        <div class="content">
          ...
          ` : this.viewMode === 'grid' ? html `
            <div class="pools-grid">
              ${repeat(pools, pool => pool.name, pool => this.renderPoolCard(pool))}
            </div>
          ` : html `
            <div class="pools-list">
              ${repeat(pools, pool => pool.name, pool => this.renderPoolListItem(pool))}
            </div>
          `}
        </div>
...
__decorate([
    state()
], StoragePoolView.prototype, "isLoading", void 0);
__decorate([
    state()
], StoragePoolView.prototype, "volumes", void 0);
__decorate([
    state()
], StoragePoolView.prototype, "expandedPools", void 0);
__decorate([
    state()
], StoragePoolView.prototype, "viewMode", void 0);
__decorate([
    state()
], StoragePoolView.prototype, "showVolumeDialog", void 0);
__decorate([
    state()
], StoragePoolView.prototype, "selectedPoolForVolume", void 0);
__decorate([
    state()
], StoragePoolView.prototype, "searchQuery", void 0);
StoragePoolView = __decorate([
    customElement('storage-pool-view')
], StoragePoolView);
export { StoragePoolView };
//# sourceMappingURL=storage-pool-view.js.map