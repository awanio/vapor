...
let StoragePoolActions = class StoragePoolActions extends LitElement {
    formatSize(bytes) {
    ...
    render() {
        ...
        const canStart = !isActive && this.pool.state !== 'building';
...
], StoragePoolActions.prototype, "pool", void 0);
StoragePoolActions = __decorate([
    customElement('storage-pool-actions')
], StoragePoolActions);
export { StoragePoolActions };
//# sourceMappingURL=storage-pool-actions.js.map