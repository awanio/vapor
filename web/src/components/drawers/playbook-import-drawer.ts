...
export class PlaybookImportDrawer extends LitElement {
  @property({ type: Boolean, reflect: true }) show = false;
  @property({ type: String }) importType: ImportType = 'upload';

  @state() private loading = false;
  @state() private error = '';
  @state() private templates: PlaybookTemplate[] = [];
  @state() private selectedTemplate?: PlaybookTemplate;

  // Form states for different import types
  @state() private uploadFile?: File;
  @state() private uploadName = '';
  @state() private uploadOverwrite = false;

  @state() private templateName = '';
  @state() private templateVariables: Record<string, string> = {};

  @state() private gitUrl = '';
  @state() private gitBranch = 'main';
  @state() private gitPath = '';
  @state() private gitAuthToken = '';
  @state() private gitSshKey = '';
  @state() private gitSyncAsSymlink = false;

  @state() private urlSource = '';
  @state() private urlName = '';

  @state() private galaxyType: 'role' | 'collection' = 'collection';
  @state() private galaxyName = '';
  @state() private galaxyVersion = '';
  @state() private galaxyRequirementsFile = '';
  @state() private galaxyForce = false;
  ...
  private async handleUpload() {
    ...
    const request: PlaybookUploadRequest = {
    ...
    return html`
      ...
      <div class="form-group">
        ...
        <input
          ...
          @input=${(e: Event) => this.uploadName = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        <label class="form-checkbox-group">
          <input
            ...
            @change=${(e: Event) => this.uploadOverwrite = (e.target as HTMLInputElement).checked}
          />
      ...
      ${this.selectedTemplate ? html`
        <div class="form-group">
          ...
          <input
            ...
            @input=${(e: Event) => this.templateName = (e.target as HTMLInputElement).value}
    ...
    return html`
      ...
      <div class="form-group">
        ...
        <input
          ...
          class="form-input"
          .value=${this.gitUrl}
          @input=${(e: Event) => this.gitUrl = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        ...
        <input
          ...
          @input=${(e: Event) => this.gitBranch = (e.target as HTMLInputElement).value}
          placeholder="main"
        />
      </div>
      ...
      <div class="form-group">
        ...
        <input
          ...
          class="form-input"
          .value=${this.gitPath}
          @input=${(e: Event) => this.gitPath = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        ...
        <input
          ...
          @input=${(e: Event) => this.gitAuthToken = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        ...
        <textarea
          ...
          @input=${(e: Event) => this.gitSshKey = (e.target as HTMLTextAreaElement).value}
      ...
      <div class="form-group">
        <label class="form-checkbox-group">
          <input
            ...
            @change=${(e: Event) => this.gitSyncAsSymlink = (e.target as HTMLInputElement).checked}
          />
    ...
    return html`
      ...
      <div class="form-group">
        ...
        <input
          ...
          @input=${(e: Event) => this.urlSource = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        ...
        <input
          ...
          class="form-input"
          .value=${this.urlName}
          @input=${(e: Event) => this.urlName = (e.target as HTMLInputElement).value}
          placeholder="my-playbook.yml"
        />
      </div>
    `;
    ...
    return html`
      ...
      <div class="form-group">
        ...
        <select
          ...
          @change=${(e: Event) => this.galaxyType = (e.target as HTMLSelectElement).value as 'role' | 'collection'}
        >
      ...
      <div class="form-group">
        ...
        <input
          ...
          @input=${(e: Event) => this.galaxyName = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        ...
        <input
          ...
          @input=${(e: Event) => this.galaxyVersion = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        ...
        <input
          ...
          @input=${(e: Event) => this.galaxyRequirementsFile = (e.target as HTMLInputElement).value}
      ...
      <div class="form-group">
        <label class="form-checkbox-group">
          <input
            ...
            @change=${(e: Event) => this.galaxyForce = (e.target as HTMLInputElement).checked}
          />
