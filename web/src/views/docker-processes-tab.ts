...
import type { DockerContainer, DockerContainersResponse } from '../types/api';

export class DockerProcessesTab extends LitElement {
  @state() private containers: DockerContainer[] = [];
  @state() private filteredContainers: DockerContainer[] = [];
              ...
              <tr>
                ...
                <td>
                  <div class="action-menu">
                    <button class="action-dots" @click="${(e: Event) => this.toggleActionMenu(e, `container-${container.id}`)}">⋮</button>
  ...
  private showStartConfirmation(id: string, name: string) {
    this.showConfirmationModal(
      'Start Container',
      `Are you sure you want to start the container "${name}"?`,
  ...
  private showStopConfirmation(id: string, name: string) {
    this.showConfirmationModal(
      'Stop Container',
      `Are you sure you want to stop the container "${name}"?`,
  ...
  private showRestartConfirmation(id: string, name: string) {
    this.showConfirmationModal(
      'Restart Container',
      `Are you sure you want to restart the container "${name}"?`,
  ...
  private showDeleteConfirmation(id: string, name: string) {
    this.showConfirmationModal(
      'Delete Container',
      `Are you sure you want to delete the container "${name}"? This action cannot be undone.`,
  ...
  async startContainer(id: string) {
    try {
      // Note: The API endpoint for starting/stopping Docker containers would need to be implemented
